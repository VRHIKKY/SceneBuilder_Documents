...
| 新規シーン | 新しくシーンを開きます。 |X
| シーンを開く | 既存のプロジェクト内にあるシーンを開きます。 |
| シーンを保存 | 自身のローカルフォルダにシーンを保存します。 |
| 名前を付けてシーンを保存 | 自身のローカルフォルダに別の名前でシーンを保存します。 |
| HEOを取り込む | 自分のローカルにあるHEOファイルを取り込みます。 |
| シーンを出力 | シーンを自分のローカルフォルダに保存します。 |
| シーンをアップロード | 現在編集しているシーンをマルチプレイ可能な環境にアップロードします。シーンをアップロードするには、Vket Accountへのログインを行う必要があります |
| 自分のワールドを開く | シーンをアップロードにてアップロードされたワールドにアクセスします。 |
...
オブジェクトを選択して、ドラッグアンドドロップを行うことでハイラルキ上で上下の移動。
...
| 項目名 | 詳細 |
|----|----|
| ニア | TPSカメラの注視点を上下に調整できます。 |
| ファー | TPSカメラの注視点を上下に調整できます。 |
...
ここに表示されているアセットをハイラルキパネル、もしくはシーンパネルにドラッグアンドドロップすることで、シーン上にオブジェクトを配置できます。
